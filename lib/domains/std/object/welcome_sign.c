...
This area is part of every LIMA based MUD out there. We are providing this area as an example only!  You can use the code to the extent that you want to code something similar by example, but otherwise, get your own ideas =P
